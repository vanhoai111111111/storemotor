                        ...
                        <div class="col-md-8">
                            <div class="form-border-left">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputCategory" name="name" placeholder="Mời bạn nhập tiêu đề tin tức" value="<?php echo  $Editpost['name'] ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="textarea-1" name="short_description" rows="4" >
                                        <?php echo $Editpost['short_description'] ?>
                                    </textarea>
                            ...
                            <div class="form-border-right">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="category_id">
                                        ...
                                        <?php foreach ($category as $item): ?>
                                            <option value="<?php echo $item['id'] ?>" <?php echo $Editpost['category_id'] == $item['id'] ? "selected = 'selected'" : ''?>>
                                                <?php echo $item['name'] ?>
                                            </option>
                                        <?php endforeach ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="image-edit" style="margin-top: 15px;">
                                        <img src="<?php echo uploads() ?>post/<?php echo $Editpost['thumbar'] ?>" width="100px" height="100px" />
                                    </div>
                                </div>
